package gay.skitbet.dubstepmod.items;

import gay.skitbet.dubstepmod.SkitDubstepMod;
import gay.skitbet.dubstepmod.utils.BeamDamage;
import gay.skitbet.dubstepmod.utils.ParticleHelper;
...
public class RedstoneDubstepGunItem extends Item {
    ...
    public TypedActionResult<ItemStack> use(World world, PlayerEntity user, Hand hand) {
        ...
        if (!world.isClient && user instanceof ServerPlayerEntity serverPlayer) {
            SkitDubstepMod.gunNetworkPlatform.startDubstep(serverPlayer, serverPlayer.getPos().toVector3f());
...
//            }
    ...
    public void onStoppedUsing(ItemStack stack, World world, LivingEntity user, int remainingUseTicks) {
        if (!world.isClient && user instanceof ServerPlayerEntity serverPlayer) {
            SkitDubstepMod.gunNetworkPlatform.stopDubstep(serverPlayer);
